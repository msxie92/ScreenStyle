...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--local_rank', default=0, type=int, help='# sthreads for loading data')
        ...
        parser.add_argument('--color2screen', action='store_true', help='continue training: load the latest model including RGB model')
